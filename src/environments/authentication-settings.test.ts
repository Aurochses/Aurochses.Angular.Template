...
export const authenticationSettings: AuthenticationSettings = {
  ...
  redirect_uri: 'http://template.test.angular.aurochses.demo.by/auth.html',
  post_logout_redirect_uri: 'http://template.test.angular.aurochses.demo.by',
  response_type: 'id_token token',
  scope: 'openid profile email api permissions',
  silent_redirect_uri: 'http://template.test.angular.aurochses.demo.by/silent-renew.html',
